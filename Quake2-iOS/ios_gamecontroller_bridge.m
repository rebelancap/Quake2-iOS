...
int iOS_GetLeftStickClick(void) {
    return [[IOSGameController sharedController] leftStickClick] ? 1 : 0;
}

int iOS_GetRightStickClick(void) {
    return [[IOSGameController sharedController] rightStickClick] ? 1 : 0;
}
...
void iOS_PerformDelayedControllerCheck(void) {
    [IOSGameController performDelayedControllerCheck];
}

void iOS_DebugControllerState(void) {
    [IOSGameController debugControllerState];
}
